...
def read_texts_from_jsonl(file_path: str, max_lines: int = None) -> Generator[str, None, None]:
    """读取JSONL文件并安全提取文本数据"""
...
def train_tokenizer(data_path: str, save_dir: str, vocab_size: int = 8192, max_lines: int = None) -> None:
    """训练并保存自定义tokenizer"""
