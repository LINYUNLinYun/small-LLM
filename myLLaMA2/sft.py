...
from pretrain_sft_dataset import SFTDataset
...
def init_model():
    ...
    # 加载预训练权重
    ckp = 'checkpoints_1gpu/pretrain_1024_18_6144_2026-03-21-18:12:12.pth'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="./dataset/input/BelleGroup_sft.jsonl", help="训练数据路径")
    parser.add_argument("--max_sample", type=int, default=None, help="仅使用前N条样本进行训练")
