...
from utils import precompute_freqs, repeat_kv, RoPE
...
class Attention(nn.Module):
    def __init__(self, args: ModelConfig):
        ...
        # 定义权重矩阵——由于LLaMA的隐层维度等于模型维度，所以后续都用模型维度作为输入维度
...
if __name__ == '__main__':
    ...
    output = attn(x, freqs_cos, freqs_sin)
    print(output.shape)
