...
class TextGenerator:
    def __init__(self, 
                 checkpoint='sft_model_215M/sft_dim1024_layers18_vocab_size6144.pth',  # 模型检查点路径
        ...
        self.model = LLaMA2(ModelConfig(dim=1024, n_layers=18))  # 实例化 LLaMA2 模型
    ...
    def chat_template(self, prompt):
        message = [
            {"role": "system", "content": "你是一个AI助手，你的名字叫小云。"},
...
if __name__ == "__main__":
    ...
    generator = TextGenerator(checkpoint='checkpoints_1gpu/pretrain_1024_18_6144_2026-03-21-18:12:12.pth')  # 初始化生成器
